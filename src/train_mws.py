...
def train_step(
    ...
    with torch.no_grad():
        ...
        model_train_repeat_frac = torch.mean((train_pred[:, acc_start:-1] == train_pred[:, acc_start+1:]).to(float))
        print(model_repeat_frac, model_train_repeat_frac)
        ...
        if config.train.wandb:
            ...
            log_data = {
                ...
                "model_train_repeat_frac": model_train_repeat_frac,
